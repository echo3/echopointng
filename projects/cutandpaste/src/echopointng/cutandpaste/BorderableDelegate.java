...
/**
 * <code>BorderableDelegate</code> is a simple delegate object
 * than can be used inside a component that implements
 * Borderable.
 */
public class BorderableDelegate extends AbstractComponentDelegate implements Borderable, Serializable {

	/**
	 * Constructs a BorderableDelegate for the given component 
	 * @param delegatee - the component to delegate for
	 */
	 ...
	 */
	public BorderableDelegate(Component delegatee, Border border) {
		super(delegatee);
		setBorder(border);
	}
