...
/**
 * <code>SizeableDelegate</code> is a simple delegate object
 * than can be used inside a component that implements <code>Sizeable</code>
 * 
 * @see echopointng.able.Sizeable
 */
public class SizeableDelegate extends AbstractComponentDelegate implements Sizeable, Serializable {

	public SizeableDelegate(Component delegatee) {
		super(delegatee);
	}
